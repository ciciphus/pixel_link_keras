...
import util
sys.path.append('/Users/ci.chen/src/pixel_link_mobile/datasets')
...
if __name__ == "__main__":
    root_dir = util.io.get_absolute_path('~/Downloads/IC15/Challenge4/')
    output_dir = util.io.get_absolute_path('~/Downloads/IC15/pixel_link/Challenge4/')
